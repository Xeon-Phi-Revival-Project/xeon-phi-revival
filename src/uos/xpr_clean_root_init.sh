...
# xpr-init provisions this deployment-specific ECDSA key into both roots.
# Dropbear's generic -r option accepts ECDSA host-key files; do not permit it
# to generate a different key before the host uploads the final payload.
