...
1. **XPR-OS maintenance and release engineering** — RC7 Candidate E is technically validated on the 5110P with source-built runtime inputs and CPython 3.12.13; preserve its exact hash while the owner reviews the finalized publication metadata and authorizes any tag or release.
