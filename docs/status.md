...
1. **XPR-OS maintenance and release engineering** — RC7 distributes the frozen G2 artifacts validated on the 5110P, with reviewed provenance, hash-bound `xpr-init` extraction, source-built runtime inputs, and CPython 3.12.13. The owner has authorized publication after final checks; future implementation changes belong beyond RC7.
