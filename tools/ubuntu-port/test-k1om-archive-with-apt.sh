...
for package in base-files-k1om hello-knc-smoke python3.5-minimal-k1om python3.5-stdlib-k1om python3.5-lib-dynload-k1om python3.5-smoke-k1om xpr-shell-compat zlib-smoke-k1om libtinfo5-k1om ncurses-smoke-k1om xpr-os-smoke xeon-phi-revival-stage2; do
