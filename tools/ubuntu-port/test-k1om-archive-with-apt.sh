...
for package in base-files-k1om hello-knc-smoke python3.5-core-k1om zlib-smoke-k1om libtinfo5-k1om ncurses-smoke-k1om xpr-os-smoke xeon-phi-revival-stage2; do
