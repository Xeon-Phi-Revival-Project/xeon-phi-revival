...
```text
/root/xeon-phi-revival-local/ubuntu-port-runs/k1om-bootstrap-package-set-20260729-041555/repo
```

The private archive was copied into an ignored local scratch directory:

```text
build/private/k1om-apt-repo-20260729-041555
```
...
The passing archive currently contains thirty-four packages:
